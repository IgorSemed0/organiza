...
export default function Edit({ item, cartaos, users }) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(route('admin.membro_cartaos.update', item.id));
    };

    return (
        <AdminLayout title="Editar Membro de Cartão">
            <Head title="Editar Membro de Cartão" />
            <Card>
                <CardHeader>
                    <div className="flex items-center justify-between">
                        <CardTitle>Editar Membro de Cartão</CardTitle>
