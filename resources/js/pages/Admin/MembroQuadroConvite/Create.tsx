...
export default function Create({ quadros, users }) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route('admin.membro_quadro_convites.store'));
    };

    return (
        <AdminLayout title="Criar Convite para Quadro">
            <Head title="Criar Convite para Quadro" />
            <Card>
                <CardHeader>
                    <div className="flex items-center justify-between">
                        <CardTitle>Criar Convite para Quadro</CardTitle>
