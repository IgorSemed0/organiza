...
export default function Create() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route('admin.tipo_users.store'));
    };

    return (
        <AdminLayout title="Criar Tipo de Utilizador">
            <Head title="Criar Tipo de Utilizador" />
            <Card>
                <CardHeader>
                    <div className="flex items-center justify-between">
                        <CardTitle>Criar Tipo de Utilizador</CardTitle>
